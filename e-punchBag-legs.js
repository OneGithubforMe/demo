...
let right = true;
let s = true;
let start = new Audio('Audio files/Instructions/Kick as they appear on either side.mp3');
...
function Exercise(results) {
    ...
    {    
        ...
        ctx1.fillText("Kick", 0.013*canvasWidth, 0.45*canvasHeight)
    ...
    {        
        ...
        ctx1.globalAlpha = 1;
        ctx1.fillStyle = "yellow";
        ctx1.fillText("Kick", 0.88*canvasWidth, 0.45*canvasHeight)
    ...
    if(rightLeg1.x > xcc && rightLeg1.y > ycc && rightLeg1.x < xcc + 0.1 && rightLeg1.y < ycc + 0.7 ||
